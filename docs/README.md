...
| `DEPLOY_INFO.md` | Production runbook: provisioning, environment variables, release, verification, rollback, and troubleshooting. | Deployment process or production infrastructure changes. |
